...
Our dataset is the `moviesgalaxies` dataset: a collection of graphs, each representing a movie.
...
The dataset can be downloaded from Netzschleuder, with a very user-friendly version at [https://moviegalaxies.com/](https://moviegalaxies.com/)
...
- Simpler models like the Chung-Lu and Erdos-Renyi models struggle with higher order structure, as is typical in networks.
